...
project1 = Project.create!(name: "My Novel", description: "Finally getting around to writing my story.")
project2 = Project.create!(name: "Book of Poems", description: "A poem every week until I've got a book.")
project3 = Project.create!(name: "Weekly Blog", description: "Journaling, but online", open: false)
